...
The widgets **AddButton**, **CartList** and **CartTotal** have access to the current state of the cart (**CartModel**) via **ScopedModelDescendant**. The ScopedModelDescendant Widget used to find the appropriate **ScopedModel** in the Widget tree.
